...
// this function creates a three-column table and adds it to the screen
   ...
   var tocTool1 = 'Nhấn vào để sắp xếp theo tên bài đăng';
   var tocHead2 = 'NGÀY ĐĂNG';
   var tocTool2 = 'Nhấn vào để sắp xếp theo ngày đăng';
   var tocHead3 = 'NHÃN';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
   ...
   if (postFilter != '') {
      tocTool3 = 'Nhấn vào đây để xem hết tất cả bài đăng.';
   }
   tocTable += '<table>';
   tocTable += '<tr>';
...
function showToc() {
  ...
  else { alert("Đợi xíu! Sitemap đang load..."); }
}
